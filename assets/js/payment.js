...
function setModalState(state) {
  ...
  switch (state) {
    case "processing":
      ...
      msgEl.textContent =
        "Please wait while we securely process your fine payment. Do not close this window.";
    ...
    case "success":
      ...
      msgEl.innerHTML =
        "Your fine has been cleared.<br>A confirmation will be sent to your registered email.";
  ...
  payBtn.addEventListener("click", function () {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        // Auto-redirect after 3 seconds showing the success message
        setTimeout(() => {
